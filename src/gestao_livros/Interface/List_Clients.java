 ...
 * @author fune5ti
 */
public class List_Clients extends javax.swing.JFrame {
public static String ret;
    /**
     * Creates new form List_Clients
     */
    public List_Clients() {
        initComponents();
   ...
   public void executeSQlQuery(String query, String message)
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(List_Clients.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new List_Clients().setVisible(true);
            }
        });
    }
