 ...
 * @author danielpires
 */
public class Reg_Func extends javax.swing.JFrame {

    /**
     * Creates new form Reg_Func
     */
    public Reg_Func() {
        initComponents();
    }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        Funcionario usr = new Funcionario();

        usr.setEmail(email.getText());
        usr.setNome(User.getText());
        usr.setPass(pass.getPassword());
        char cpss []  = pass_conf.getPassword();// confirmacao password
        ...
        {
            if((novo.checkPass(conf, generatedPassword) == true))
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reg_Func.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
